...
let
  ...
  librewolfConfigPath = if isDarwin then
  ...
  wrapPackage = package:
    let
      ...
      bcfg = setAttrByPath [ browserName ] {};
...
in {
  meta.maintainers = [ maintainers.rycee maintainers.kira-bruneau maintainers.onny ];
        ...
        type = types.attrsOf (types.submodule ({ config, name, ... }: {
          options = {
            ...
            extensions = mkOption {
              ...
              '';
              description = ''
                List of Firefox/Librewolf add-on packages to install for this profile.
                ...
                to list the available Firefox/Librewolf add-ons.
  ...
  config = mkIf cfg.enable {
    ...
    home.file = mkMerge ([{
      ...
      "${profilesPath}/${profile.path}/user.js" = mkIf (profile.extraConfig != ""
        || profile.bookmarks != [ ]) {
          text =
            mkUserJs profile.extraConfig profile.bookmarks;
        };
